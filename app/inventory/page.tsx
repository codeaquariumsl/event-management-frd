    ...
    <AppShell>
        ...
        actions={
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 rounded-lg bg-[#162333] border border-[#23354c] px-3.5 py-2 text-xs font-semibold text-slate-200 hover:text-white hover:bg-[#1c2c40] transition-colors"
            >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-lg transition-all ${
            activeTab === 'items'
              ...
              : 'text-slate-400 hover:text-white hover:bg-[#121c2a]'
          }`}
        >
      ...
      {activeTab === 'items' && (
        <div className="space-y-4">
          {/* Filters Bar */}
          <div className="flex flex-col lg:flex-row gap-3 items-center justify-between rounded-xl bg-[#0e1622] border border-[#1d2b3c] p-4">
            ...
            <div className="flex flex-wrap items-center gap-2.5 w-full lg:w-auto">
              ...
              <select
                ...
                className="px-3 py-2 text-xs bg-[#131d2a] border border-[#1f2f42] rounded-lg text-white focus:outline-none focus:border-[#00e5c9]"
              >
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm text-slate-300">
                ...
                <tbody className="divide-y divide-[#1a2737]">
                  {filteredItems.map((item) => {
                    ...
                    return (
                      <tr key={item.id} className="hover:bg-[#131d2b] transition-colors">
                        {/* Name & SKU */}
                        <td className="px-5 py-4">
                          ...
                          <div className="flex items-center gap-2 mt-0.5">
                            ...
                            {item.unit && (
                              <span className="text-[10px] px-1.5 py-0.2 rounded bg-[#182637] text-slate-400 border border-[#23354b]">
                                {item.unit}
                              </span>
                            )}
                          </div>
                        ...
                        {/* Category */}
                        <td className="px-5 py-4">
                          <span className="inline-flex items-center text-xs font-medium px-2.5 py-1 rounded-md bg-[#162232] text-slate-300 border border-[#223348]">
                            {item.category}
                          </span>
                        </td>
                        ...
                        <td className="px-5 py-4">
                          ...
                          {/* Stock Progress Bar */}
                          <div className="w-28 h-1.5 bg-[#182637] rounded-full overflow-hidden mt-1.5">
                            <div
                        ...
                        {/* Rental Rate */}
                        <td className="px-5 py-4 text-right font-semibold text-[#00e5c9]">
                          {formatCurrency(item.rentalRate)}
                        </td>

                        {/* Quick Adjust */}
                        <td className="px-5 py-4 text-center">
                          <div className="inline-flex items-center rounded-lg border border-[#23354b] bg-[#141e2b] p-0.5">
                            <button
                              onClick={() => adjustStock(item, -1)}
                              disabled={item.availableQuantity <= 0}
                              className="px-2 py-0.5 text-xs text-slate-300 hover:bg-[#1e2f45] rounded disabled:opacity-30"
              ...
              {filteredItems.length === 0 && (
                <div className="text-center py-16">
                  ...
                  <h3 className="text-base font-semibold text-white">No Equipment Items Found</h3>
                ...
                >
                  ...
                  <div className="mt-5 pt-3 border-t border-[#1a2636] flex items-center justify-between">
                    <div className="flex items-center gap-1.5 text-xs text-slate-400 font-medium">
                      <Package className="h-3.5 w-3.5 text-[#00e5c9]" />
                      <span>
                        <strong className="text-white">{count}</strong> inventory {count === 1 ? 'item' : 'items'}
                      </span>
                    </div>
      ...
      >
        <form onSubmit={handleSaveItem} className="space-y-4 text-sm">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-[#131d2a] border border-[#1f2f42] rounded-lg text-white font-semibold text-[#00e5c9] focus:outline-none focus:border-[#00e5c9]"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              <label className="block text-xs font-medium text-slate-300 mb-1">Total Stock</label>
              <input
                type="number"
                min="1"
                required
            ...
            <div>
              <label className="block text-xs font-medium text-slate-300 mb-1">Available Now</label>
              <input
                type="number"
                min="0"
          ...
          <div>
            <label className="block text-xs font-medium text-slate-300 mb-1">Technical Specifications</label>
            <input
              type="text"
