      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2 border-b border-slate-200 dark:border-[#1d2b3c] pb-3">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-lg transition-all ${activeTab === 'items'
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-lg transition-all ${activeTab === 'categories'
              ? 'bg-[#00e5c9] text-black shadow-md shadow-[#00e5c9]/20'
              : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-[#121c2a] border border-slate-200 dark:border-transparent'
              }`}
          >
                  ...
                  >
                    <div>
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <span
                          className={`text-xs px-2 py-0.5 rounded-full font-medium ${cat.status === 'Active'
