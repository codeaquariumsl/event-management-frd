      ...
      <div className="space-y-4 sm:space-y-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-5">
          ...
          <div className="lg:col-span-2 rounded-xl border border-slate-200 dark:border-[#1d2b3c] bg-white dark:bg-[#0c1420] p-4 sm:p-5 shadow-sm flex flex-col justify-between">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-[#1a2738] mb-2">
              <div>
              ...
              <span className="rounded bg-[#00e5c9]/10 px-2 py-0.5 text-xs font-bold text-[#00897b] dark:text-[#00e5c9] border border-[#00e5c9]/20">
          ...
          <div className="rounded-xl border border-slate-200 dark:border-[#1d2b3c] bg-white dark:bg-[#0c1420] p-4 sm:p-5 shadow-sm flex flex-col justify-between">
            <div className="pb-3 border-b border-slate-100 dark:border-[#1a2738] mb-2">
              <h2 className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider">
                Event Pipeline Status
              </h2>
              <p className="text-[11px] text-slate-500 dark:text-slate-400">Distribution across active booking stages</p>
            </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-slate-100 dark:border-[#1a2738]">
                <div className="flex items-center gap-3">
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 dark:text-slate-400">Scheduled execution calendar</p>
                  </div>
                </div>
          ...
          <div className="rounded-xl border border-slate-200 dark:border-[#1d2b3c] bg-white dark:bg-[#0c1420] p-4 sm:p-5 shadow-sm flex flex-col justify-between">
            <div>
              ...
              {activityTab === 'payments' ? (
                ...
                <div>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 mb-2.5">Equipment & talent distribution</p>
