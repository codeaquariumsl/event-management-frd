      ...
      {isEditing ? (
        <div className="rounded-xl border border-slate-200 dark:border-[#1d2b3c] bg-white dark:bg-[#0e1622] p-6 space-y-6">
          ...
          <div className="space-y-3">
            <h3 className="text-xs font-bold uppercase tracking-wider text-[#00897b] dark:text-[#00e5c9]">Line Items</h3>
            {editData.items?.map((item, index) => (
              <div
                key={item.id || index}
                className="grid grid-cols-1 sm:grid-cols-6 gap-2 bg-slate-50 dark:bg-[#121c29] p-3 rounded-lg border border-slate-200 dark:border-[#1d2b3c] items-center text-xs"
              >
                ...
                <div className="text-right font-bold text-[#00897b] dark:text-[#00e5c9] font-mono">
        ...
        <div className="rounded-2xl border border-slate-200 dark:border-[#1d2b3c] bg-white dark:bg-[#0c131d] p-8 sm:p-12 shadow-2xl space-y-8 print:border-none print:p-0 print:bg-white print:text-black">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-6 pb-6 border-b border-slate-200 dark:border-[#1d2b3c] print:border-slate-300">
            <div>
              ...
              <div className="mt-4 text-xs text-slate-500 dark:text-slate-400 print:text-slate-600 space-y-1">
            ...
            <div className="sm:text-right space-y-1.5">
              ...
              <div className="text-xs text-slate-500 dark:text-slate-400 print:text-slate-600">
                Date: <strong className="text-slate-800 dark:text-slate-200 print:text-black">{quotation.createdAt}</strong>
              </div>
              <div className="text-xs text-slate-500 dark:text-slate-400 print:text-slate-600">
          ...
          <div className="overflow-hidden rounded-xl border border-slate-200 dark:border-[#1d2b3c] print:border-slate-300">
            <table className="w-full text-left text-xs">
              <thead className="bg-slate-100 dark:bg-[#121d2b] print:bg-slate-100 uppercase tracking-wider font-bold text-slate-600 dark:text-slate-400 print:text-slate-700 border-b border-slate-200 dark:border-[#1d2b3c] print:border-slate-300">
                <tr>
