        ...
        {toasts.map((toast) => (
          <div
            ...
            className={cn(
              ...
              toast.type === 'success' && 'border-emerald-700/60 bg-[#091a14]/95 text-emerald-300',
              toast.type === 'error' && 'border-rose-700/60 bg-[#1c0d12]/95 text-rose-300',
              toast.type === 'info' && 'border-[#00e5c9]/40 bg-[#07161b]/95 text-[#00e5c9]'
            )}
          >
            ...
            {toast.type === 'info' && <Info className="h-4 w-4 shrink-0 text-[#00e5c9]" />}
