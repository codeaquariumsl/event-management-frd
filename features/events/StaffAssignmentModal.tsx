  ...
  return (
    ...
    >
      <div className="space-y-4 text-xs">
          ...
          <div className="rounded-xl border border-amber-500/40 bg-amber-950/40 p-4 text-amber-200">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                <h4 className="font-bold text-amber-800 dark:text-amber-300">Potential Scheduling Conflict</h4>
                <p className="text-slate-700 dark:text-slate-300">
                  <strong className="text-slate-900 dark:text-white">{conflictWarning.staffName}</strong> is already booked on{' '}
                  <span className="underline font-semibold">{conflictWarning.conflictingEvent?.name}</span>:
                </p>
                <div className="rounded bg-white dark:bg-[#0c141f] border border-amber-200 dark:border-amber-500/20 p-2 text-[11px] text-amber-900 dark:text-amber-100 font-mono">
            ...
            <div className="mt-3 flex items-center justify-end gap-2 pt-2 border-t border-amber-200 dark:border-amber-500/20">
              <button
                type="button"
                onClick={() => setConflictWarning(null)}
                className="rounded-lg border border-amber-300 dark:border-amber-500/30 px-3 py-1.5 text-xs text-amber-800 dark:text-amber-200 hover:bg-amber-100 dark:hover:bg-amber-900/30 transition-colors"
              >
                Cancel
              </button>
              <button
        ...
        <div>
          <label className="block font-medium text-slate-700 dark:text-slate-300 mb-1">Select Staff Member</label>
          <select
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block font-medium text-slate-700 dark:text-slate-300 mb-1">Agreed Payment (LKR)</label>
            <input
              type="number"
              value={paymentAmount}
        ...
        <div className="rounded-lg bg-slate-50 dark:bg-[#111a24] border border-slate-200 dark:border-[#1d2b3b] p-3 text-slate-600 dark:text-slate-400 text-[11px] flex items-center gap-2">
